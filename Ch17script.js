...
function selectSeat(row, seat) {
    ...
    localStorage.setItem('seatsCh17', JSON.stringify(selectedSeats))
...
function clearSeats() {
    ...
    localStorage.removeItem('seatsCh17')
    window.location.reload()
}

window.addEventListener('load', () => {
    selectedSeats = JSON.parse(localStorage.getItem('seatsCh17')) || [];
    if (document.getElementById("cinema-seats")) {
        generateSeats();
    }
});
